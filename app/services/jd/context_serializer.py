...
def to_dict(context: JDProcessingContext) -> dict:
    return {
        ...
        "prompt_template_id": str(context.prompt_template_id) if context.prompt_template_id is not None else None,
...
def from_dict(data: dict) -> JDProcessingContext:
    context = JDProcessingContext(
        ...
        prompt_template_id=UUID(data["prompt_template_id"]) if data.get("prompt_template_id") is not None else None,
