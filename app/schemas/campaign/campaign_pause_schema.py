...
class PauseImpactSummaryResponse(BaseModel):
    ...
    warning: str = ("Pausing will stop new uploads, halt queued processing tasks, and "
        "suspend automated pipeline progression."
    )


class ResumeSummaryResponse(BaseModel):
    """data for the resume confirmation dialog."""
    ...
    warning: str = ("Confirming will re-queue all suspended tasks and re-enable uploads."
    )
