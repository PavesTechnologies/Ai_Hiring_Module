...
class ActionType(enum.Enum):
    ...
    # Settings -> AI model (ai_provider_config). DB enum values added by
    # migrations 3f9a6c2d1e57_ai_provider_config / 8b1d4e6f2a90_ai_provider_config_multi.
    ...
    JD_SKILL_UPDATED = "JD_SKILL_UPDATED"
    JD_SKILL_REMOVED = "JD_SKILL_REMOVED"
